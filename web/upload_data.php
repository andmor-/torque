...
#echo :<br />Debug -04 $current_table_list_query<br />";
...
#echo "<br />Debug 07 $sessprofilename<br />";
      if ($key == 'profileFuelType') {
        $sessprofilefueltype = $value;
      }
#echo "<br />Debug 08 $sessprofilefueltype<br />";
      if ($key == 'profileWeight') {
        $sessprofileweight = $value;
      }
#echo "<br />Debug 09 $sessprofileweight<br />";
      if ($key == 'profileVe') {
        $sessprofileve = $value;
      }
#echo "<br />Debug 10 $sessprofileve<br />";
      if ($key == 'profileFuelCost') {
        $sessprofilefuelcost = $value;
      }
#echo "<br />Debug 11 $sessprofilefuelcost<br />";
      $submitval = 3;
...
#echo "<br />Debug 12<br />";
    ...
    if (!in_array($key, $dbfields) and $submitval == 2) {
      ...
      while( $row = mysqli_fetch_assoc($table_list) ) {
        ...
        if (!in_array($key, $dbfields_per_table) and $submitval == 1) {
...
#echo "<br />Debug 21 $sessionqrystring<br />";
...
#  $datavalues = array_merge($values, $sessuploadid, $sesstime);
  ...
  $datakeys[] = 'time';
  $datavalues[] = $sesstime; 
#echo "<br />Debug 29 $submitval ".sizeof($datakeys)." ".sizeof($datavalues)."<br />";
...
#echo "<br />Debug 39 $dataqrystring<br />";
...
#echo "<br />Debug 41 $profileqrystring<br />";
